...
$global_layout  = 'layout_2r';
$global_width_content = get_theme_mod( 'global_width_content', '1170' );


$global_layout_sidebar = apply_filters( 'digitax_get_layout', '' );
...
$global_width_site = apply_filters( 'digitax_width_site', '' );
...
$global_width_content_wrap  = $global_width_content+20;

$global_cssCode .= <<<CSS
.wrap_site{
    max-width: {$global_width_content_wrap}px;
}
.container,
body .elementor-section.elementor-section-boxed>.elementor-container{
    max-width: {$global_width_content_wrap}px!important;
}
