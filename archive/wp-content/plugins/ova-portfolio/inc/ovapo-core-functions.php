...
function ovapo_pagination_plugin($ovacs_query = null) {
	...
	echo wp_kses( __( '<div class="blog_pagination"><ul class="pagination">','ova-portfolio' ), true ) . "\n";
	...
	if ( ! in_array( 1, $links ) ) {
		...
		if ( ! in_array( 2, $links ) )
			echo wp_kses( __('<li><span class="pagi_dots">...</span></li>', 'ova-portfolio' ) , true);
	}
	...
	echo wp_kses( __( '</ul></div>', 'ova-portfolio' ), true ) . "\n";
