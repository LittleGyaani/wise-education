        ...
        foreach ($post_types as $post_type) {
            $general_options[$post_type] = array(
                ...
                array(
                    'name' => 'header',
                    'type' => 'select',
                    'label' => esc_html__('Header Layout Style (optional)', 'themetonaddon'),
                    'default' => 'default',
                ...
                array(
                    'name' => 'slider',
                    'type' => 'select',
                    'label' => esc_html__('Top Slider', 'themetonaddon'),
                    'default' => 'noslider',
                ...
                array(
                    'name' => 'layout',
                    'type' => 'thumbs',
                    'label' => esc_html__('Page Layout', 'themetonaddon'),
                    'default' => 'default',
                    'option' => array(
                    ...
                    'desc' => esc_html__('Select Page Layout. Default value on Theme Options: ', 'themetonaddon') . Themeton_Std::getopt($post_type.'_layout')
                ),

                array(
                    'name' => 'sidebar_right',
                    'type' => 'select',
                    'label' => esc_html__('Right sidebar', 'themetonaddon'),
                    'default' => 'noslider',
                    'option' => array_merge(array(
                        'default' => esc_attr__('Default on Theme Options', 'themetonaddon'),
                    ), $sidebars
                    ),
                    'desc' => esc_html__('Default value on Theme Options: ', 'themetonaddon') . Themeton_Std::getopt($post_type.'_sidebarright')
                ),
                array(
                    'name' => 'sidebar_left',
                    'type' => 'select',
                    'label' => esc_html__('Left sidebar', 'themetonaddon'),
                    'default' => 'noslider',
                    'option' => array_merge(array(
                        'default' => esc_attr__('Default on Theme Options', 'themetonaddon'),
                    ), $sidebars
                    ),
                    'desc' => esc_html__('Default value on Theme Options: ', 'themetonaddon') . Themeton_Std::getopt($post_type.'_sidebarleft')
                ),

                array(
                    'type' => 'select',
                    'name' => 'page-title',
                    'label' => esc_html__('Page Title Show', 'themetonaddon'),
                    'desc' => esc_html__('Default value on Theme Options: ', 'themetonaddon') . ((Themeton_Std::getopt($post_type.'-title-hide') == '1') ? esc_attr__('Show', 'themetonaddon') : esc_attr__('Hidden', 'themetonaddon')),
                    'option' => array(
                        'default' => esc_html__('Default', 'themetonaddon'),
                        '1' => esc_html__('Show', 'themetonaddon'),
                        '0' => esc_html__('Hide', 'themetonaddon'),
                    ),
                    'default' => 'default'
                ),
                array(
                    'type' => 'select',
                    'name' => 'featuredimage',
                    'label' => esc_html__('Featured Image Show', 'themetonaddon'),
                    'desc' => esc_html__('Default value on Theme Options: ', 'themetonaddon') . ((Themeton_Std::getopt($post_type.'_featuredimage') == '1') ? esc_attr__('Show', 'themetonaddon') : esc_attr__('Hidden', 'themetonaddon')),
                    'option' => array(
                        'default' => esc_html__('Default', 'themetonaddon'),
                        '1' => esc_html__('Show', 'themetonaddon'),
                        '0' => esc_html__('Hide', 'themetonaddon'),
                ...
                array(
                    'type' => 'select',
                    'name' => 'authorbox',
                    'label' => esc_html__('Post Author Box Show', 'themetonaddon'),
                    'desc' => esc_html__('Default value on Theme Options: ', 'themetonaddon') . ((Themeton_Std::getopt($post_type.'_authorbox') == '1') ? esc_attr__('Show', 'themetonaddon') : esc_attr__('Hidden', 'themetonaddon')),
                    'option' => array(
                        'default' => esc_html__('Default', 'themetonaddon'),
                        '1' => esc_html__('Show', 'themetonaddon'),
                        '0' => esc_html__('Hide', 'themetonaddon'),
                ...
                array(
                    'type' => 'text',
                    'name' => 'content_top',
                    'label' => esc_html__('Content top padding (optional)', 'themetonaddon'),
                    'desc' => esc_html__('Number value in pixels. Empty presents default from Theme Options. Default value on Theme Options: ', 'themetonaddon') . Themeton_Std::getopt('content-top'),
                    'default' => ''
                ),
                array(
                    'type' => 'text',
                    'name' => 'content_bottom',
                    'label' => esc_html__('Content bottom padding (optional)', 'themetonaddon'),
                    'desc' => esc_html__('Number value in pixels. Empty presents default from Theme Options. Default value on Theme Options: ', 'themetonaddon') . Themeton_Std::getopt('content-bottom'),
                    'default' => ''
                )
            );
        }
