        ...
        switch ($type) {
            ...
            case 'image':
                ...
                $html .= '<div class="pmeta_item_browse">
                            ...
                            <a href="javascript:;" class="button pmeta_button_browse">'.esc_html__('Browse...', 'themetonaddon').'</a>
                            <div class="browse_preview">' . ($value != '' ? '<img src="' . $value . '" /><a href="javascript:;">'.esc_html__('Remove', 'themetonaddon').'</a>' : '') . '</div>
                        </div>';
                return $html;
                break;
            case 'metro':
            ...
            case 'font_icon':
                ...
                $html .= '<div class="pmeta_item_font">
                                    <input type="text" ' . $gatts . ' value="' . esc_attr($value) . '"/>
                                    <a href="javascript:;" class="button pmeta_button_font">'.esc_html__('Font Icon...', 'themetonaddon').'</a>
                            </div>';
                return $html;
                break;
            case 'onepage':
                ...
                $html .= '<option value="0">' . esc_attr__('Choose page...', 'themetonaddon') . '</option>';
                $pages = get_pages();
                ...
                $html .= '</select>';
                $html .= '&nbsp;&nbsp;<a href="javascript:;" class="button" id="button_onepage_add">'.esc_html__('Add Page', 'themetonaddon').'</a>';
                $html .= '&nbsp;&nbsp;<a href="javascript:;" class="button" id="button_op_custom_link">'.esc_html__('Custom Link', 'themetonaddon').'</a>';
            ...
            case 'gallery':
                ...
                $html = '<div class="pmeta_gallery">
                            <a href="javascript:;" class="button pmeta_button_browse">'.esc_html__('Insert/Update Gallery...', 'themetonaddon').'</a>
                            <a href="javascript:;" class="pmeta_remove" title="'.esc_attr__('Remove Gallery', 'themetonaddon').'">(x)</a>
            ...
            case 'list_content':
                ...
                $html = '<div class="pmeta_list_content">
                            ...
                            <div class="pm-list-tpl">
                                <div class="pmlc-item">
                                    <input type="text" class="pmlc-item-text" placeholder="'.esc_attr__('Label', 'themetonaddon').'">
                                    <textarea class="pmlc-item-content" placeholder="'.esc_attr__('Content', 'themetonaddon').'"></textarea>
                                    <a href="javascript:;" class="pmeta_remove" title="'.esc_attr__('Remove', 'themetonaddon').'"><i class="dashicons dashicons-no-alt"></i></a>
                            ...
                            <a href="javascript:;" class="button pmeta_button_browse">'.esc_html__('Add Item', 'themetonaddon').'</a>
                        </div>';
                return $html;
                break;
            ...
            case 'background':
                ...
                $html .= '<div class="pmeta_item_background">
                                ...
                                <div class="browse_preview" style="'.($values['url']=='' ? 'display:none;' : '').'">
                                    ...
                                    <a href="javascript:;">'.esc_html__('Remove', 'themetonaddon').'</a>
                                </div>
                ...
                break;
            default:
                return esc_html__('Option type does not prepared!', 'themetonaddon');
                break;
        }
