    ...
    protected function content( $atts, $content = null){
        ...
        if ($style == 'default') {
            ...
            if (isset($carousel) && $carousel == 'yes') {
                $result ='<div class="uk-slider '.$extra_class.'">';
                if(get_template()=='rehub') {
                    $result ='<div class="uk-slider '.$extra_class.'" data-uk-slider="clsActivated: uk-transition-active; center: true;">';
                }
            }else{
