        ...
        foreach($allevents as $post) {
                ...
                $event.= "<div class='event_content mb4'>
                                <div class='uk-box-shadow-small'>
                                    ...
                                    <div class='event_meta uk-padding'>
                                         ...
                                         <p>$excerpt </p>  
                                         <a href='".esc_url( tribe_get_event_link() )."' class='more'>".esc_html__('Read more','themetonaddon')."</a>
                                    </div> 
                                </div>
                            </div>";
            }
                ...
                $event.="<div class='uk-grid uk-margin-medium-bottom uk-width-1-1 m0'>
                            ...
                            <div class='uk-width-1-2@m uk-grid uk-width-1-2@l item uk-padding-small m0'>
                                <div class='event_meta pb4'>
                                    ...
                                    <a href='".esc_url( tribe_get_event_link() )."' class='uk-button uk-button-default mt4'>".esc_html__('book your ticket')." </a>
                                </div> 
                            </div>
                        </div>";
            }
            ...
            if($style == 9){
                ...
                $event.="<div><div class='uk-card uk-card-body'>
                                ...
                                <a href='".esc_url( tribe_get_event_link() )."' class='uk-button uk-button-default mt4'>".esc_html__('read more', 'themetonaddon')."</a>
                        </div></div>";
            }
            if($style == 12){
            ...
            if($style == 13){
                ...
                $event.="<li class='slideitem'>
                        ...
                        <a href='".esc_url( tribe_get_event_link() )."' class='uk-button uk-button-default mt4'>".esc_html__('book your ticket', 'themetonaddon')." </a>
