...
class WPBakeryShortCode_Themetonaddon_Music_Player extends WPBakeryShortCode {
    ...
    if($postformat == '0') {
        ...
        return sprintf('<div id="music_player">
                        ...
                        </div>', $first['song'], esc_html__('Songs', 'themetonaddon'), "$index", $songs, $first['image'], $first['title'], $first['artist']);
...
vc_map( array(
    "name" => esc_html__('Music Player', 'themetonaddon'),
    "description" => esc_html__("Create Playlist", 'themetonaddon'),
    ...
    'params' => array(
        ...
        array(
            'type' => 'param_group',
            'heading' => esc_html__('Custom Audio Files', 'themetonaddon'),
            'param_name' => 'list',
            ...
            'params' => array(
                ...
                array(
                    ...
                    'param_name' => 'title',
                    "value" => esc_html__('Title', 'themetonaddon'),
                    'admin_label' => true,
                    'holder' => 'div'
                ),
                ...
                array(
                    'type' => 'textfield',
                    'heading' => esc_html__('Artist', 'themetonaddon'),
                    'param_name' => 'artist',
                    'value' => 'Artist'
                ),
                ...
                array(
                    'type' => 'textfield',
                    'heading' => esc_html__('Song Url', 'themetonaddon'),
                    'param_name' => 'song',
                    'value' => ''
                ),
                ...
                array(
                    'type' => 'attach_image',
                    "param_name" => "image",
                    "heading" => esc_html__("Poster Image", 'themetonaddon'),
                    "value" => ''
                ),

                array(
                    'type' => 'textfield',
                    'heading' => esc_html__('Duration', 'themetonaddon'),
                    'param_name' => 'duration',
                    'value' => '01:00'
                )
