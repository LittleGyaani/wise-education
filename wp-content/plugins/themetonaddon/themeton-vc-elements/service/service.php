...
class WPBakeryShortCode_service_box extends WPBakeryShortCode {
    protected function content( $atts, $content = null){
        ...
        if ($style == 'cwa') {
            ...
            $result .= '<div class="uk-card uk-card-hover uk-text-center" data-uk-toggle="target: > .toggle-text; mode: media;animation: uk-animation-fade; cls: service-visible; media: @s;">
