...
class TT_Post_type_PT{
    ...
    function __construct(){
        ...
        if( wp_get_theme()->template !== 'lagom' ) {
            unset($this->post_types['hotelroom']);
            unset($this->post_types['rent']);
            unset($this->post_types['cause']);
        }
...
class Themeton_Tpl_Social{
    ...
    public static function social_share_button() {
        ...
        $share_button = array( 
                    'facebook' => array('url' => 'https://www.facebook.com/sharer.php?u='.$title ,
