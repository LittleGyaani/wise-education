...
class WPRT_Spacer extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_spacer',
            esc_html__( 'Empty Space', 'bauer' ),
            array(
                'classname'   => 'widget_spacer',
                'description' => esc_html__( 'Blank space with custom height.', 'bauer' )
            )
        );
    }
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id( 'desktop' ) ); ?>"><?php esc_html_e( 'Desktop screen:', 'bauer' ); ?></label>
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id( 'mobi' ) ); ?>"><?php esc_html_e( 'Mobile screen:', 'bauer' ); ?></label>
...
add_action( 'widgets_init', 'register_bauer_spacer' );

// Register widget
function register_bauer_spacer() {
