...
class Lastest_Tweets extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_twitter',
            esc_html__( 'Lastest Tweets', 'bauer' ),
            array(
                'classname'   => 'widget_twitter',
                'description' => esc_html__( 'Display Lastest Tweets.', 'bauer' )
            )
        );
    }
    ...
    function widget( $args, $instance ) {
        ...
        if ( $tweets ) {
	        ...
	        foreach ( $tweets as $tweet ) {
                ...
                echo '<div class="tweet-icon"><i class="fab fa-twitter"></i></div>';
    ...
    function form( $instance ) {
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'consumer_key' ) ); ?>"><?php esc_html_e( 'Consumer Key:', 'bauer' ); ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'consumer_secret' ) ); ?>"><?php esc_html_e( 'Consumer Secret:', 'bauer' ); ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'access_token' ) ); ?>"><?php esc_html_e( 'Access Token:', 'bauer' ); ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'access_token_secret' ) ); ?>"><?php esc_html_e( 'Access Token Secret:', 'bauer' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dtime' ) ); ?>"><?php esc_html_e( 'Date Type:', 'bauer' ); ?></label>
            <select id="<?php echo esc_attr( $this->get_field_id( 'dtime' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'dtime' ) ); ?>">
                <option value="date" <?php selected( 'date', $instance['dtime'] ); ?>><?php esc_html_e( 'Date', 'bauer' ) ?></option>
                <option value="timeago" <?php selected( 'timeago', $instance['dtime'] ); ?>><?php esc_html_e( 'Time Ago', 'bauer' ) ?></option>
            </select>
        </p>
        
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'cachetime' ) ); ?>"><?php esc_html_e( 'Time of cache : (in second)', 'bauer' ); ?></label>
...
add_action( 'widgets_init', 'register_bauer_lastest_tweets' );

// Register widget
function register_bauer_lastest_tweets() {
