...
class WPRT_Socials extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_socials',
            esc_html__( 'Socials', 'bauer' ),
            array(
                'classname'   => 'widget_socials',
                'description' => esc_html__( 'Display the socials.', 'bauer' )
            )
        );
    }
    ...
    function form( $instance ) {
        ...
        $fields = array(
            'twitter' => esc_html__( 'Twitter URL:', 'bauer' ),
            'facebook' => esc_html__( 'Facebook URL:', 'bauer' ),
            'youtube' => esc_html__( 'Youtube URL:', 'bauer' ),
            'vimeo' => esc_html__( 'Vimeo URL:', 'bauer' ),
            'tumblr' => esc_html__( 'Tumblr URL:', 'bauer' ),
            'pinterest' => esc_html__( 'Pinterest URL:', 'bauer' ),
            'linkedin' => esc_html__( 'LinkedIn URL:', 'bauer' ),
            'instagram' => esc_html__( 'Instagram URL:', 'bauer' ),
            'github' => esc_html__( 'Github URL:', 'bauer' ),
            'apple' => esc_html__( 'Apple URL:', 'bauer' ),
            'android' => esc_html__( 'Android URL:', 'bauer' ),
            'behance' => esc_html__( 'Behance URL:', 'bauer' ),
            'dribbble' => esc_html__( 'Dribbble URL:', 'bauer' ),    
            'flickr' => esc_html__( 'Flickr URL:', 'bauer' ),
            'paypal' => esc_html__( 'Paypal URL:', 'bauer' ),
            'soundcloud' => esc_html__( 'Soundcloud URL:', 'bauer' ),
            'spotify' => esc_html__( 'Spotify URL:', 'bauer' )
        ); ?>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e('Width:', 'bauer') ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e('Height:', 'bauer') ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>"><?php esc_html_e('Icon Font Size:', 'bauer') ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'rounded' ) ); ?>"><?php esc_html_e('Rounded:', 'bauer') ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'gap' ) ); ?>"><?php esc_html_e('Spacing Between Items:', 'bauer') ?></label>
...
add_action( 'widgets_init', 'register_bauer_socials' );
// Register widget
function register_bauer_socials() {
