...
foreach ( $boxicon as $data ) {
	...
	if ( ! empty( $data[$icon] ) ) {
		...
		$html .= '<div class="bauer-icon '. $icon_cls .'"'. $icon_data .'><span class="icon" style="'. $icon_css .'"><i class="'. $data[$icon] .'"></i></span></div>';
	}
...
echo '<div class="bauer-icon-list clearfix '. $cls .'">'. $html .'</div>';
?>