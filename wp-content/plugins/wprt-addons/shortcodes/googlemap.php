...
<script type="text/javascript">
    ...
    google.maps.event.addDomListener(window, "load", bauer_vc_gmap);
</script>';

printf( '%1$s<div id="%2$s" class="bauer-google-map" style="%3$s"></div>', $html, $id, $css );