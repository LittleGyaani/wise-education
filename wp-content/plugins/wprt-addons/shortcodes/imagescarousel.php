...
if ( ! empty( $images ) ) {
    wp_enqueue_script( 'bauer-owlcarousel' );
    $images = explode( ',', trim( $images ) );

    $html  .= '<div class="bauer-images-carousel '. $cls .'" data-auto="'. $auto_scroll .'" data-loop="'. $loop .'" data-gap="'. $gap .'" data-column="'. $column .'" data-column2="'. $column2 .'" data-column3="'. $column3 .'">
