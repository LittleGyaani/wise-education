                    ...
                    <span class="comment-reply">
                        <?php comment_reply_link( array_merge( $args, 
                            array(
                                ...
                                'reply_text' => esc_html__('Reply', 'medio') .' <span uk-icon="icon:arrow-right;ratio:0.7"></span>'
                            ) ) ); ?>
                    </span>
                </div>
            </div>
    ...
    function medio_theme_comment_nav() {
        ...
        <nav class="navigation comment-navigation" role="navigation">
            ...
            <div class="nav-links uk-clearfix">
                <?php if ( get_previous_comments_link( esc_html__('Older Comments', 'medio') ) ) : ?>
                    <div class="nav-previous"><?php echo get_previous_comments_link( esc_html__('Older Comments', 'medio') ); ?></div>
                <?php endif; ?>
                <?php if ( get_next_comments_link( esc_html__('Newer Comments', 'medio') ) ) : ?>
                    <div class="nav-next"><?php echo get_next_comments_link( esc_html__('Newer Comments', 'medio') ); ?></div>
                <?php endif; ?>
            </div><!-- .nav-links -->
...
<div id="comments" class="comments-area">    
    ...
    <div class="comments-wrapper">
        <h2 class="comments-title medio-brand-title" data-title="<?php esc_attr_e('Comments', 'medio'); ?>">
            <?php
                printf( _nx( 'One comment', '%1$s Comments', get_comments_number(), 'comment', 'medio' ),
            ...
            array(
                ...
                'fields' => array(
                    ...
                    'website' => '<div class="mt3">
                                    ...
                                    '" placeholder="'.esc_attr__('Website', 'medio').'"/></div>',
                ),
                'comment_field' => '<textarea id="comment" class="uk-textarea" name="comment" placeholder="'.esc_attr__('Comments', 'medio').'"></textarea>'
            )
        );
    ?>
</div>