        ...
        $boxSections[] = array(
            ...
            'fields'        => array(
                ...
                array(
                    ...
                    'type'     => 'link_color',
                    'title'    => esc_html__('Menu text color', 'medio'),
                ...
                array(
                    'id'       => 'header-color-menuactive',
                    'type'     => 'color',
                    'title'    => esc_html__('Menu active/hover background color', 'medio'),
                    'desc'     => esc_html__('This color applied top level menu only.', 'medio'),
                ),
                array(
                    'id'       => 'header-color-menuactiveborder',
                    'type'     => 'color',
                    'title'    => esc_html__('Menu active/hover border color', 'medio'),
                    'desc'     => esc_html__('This color applied top level menu only.', 'medio'),
                ),
                // Sub menu
                array(
