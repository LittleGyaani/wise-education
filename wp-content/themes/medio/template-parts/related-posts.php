...
if ($tags) {
	...
	?>
		...
		<div class="uk-container related-post" >
			<h3 class="medio-brand-title"><?php esc_html_e('Related Posts','medio'); ?></h3>
			<div class="uk-grid">
			<?php
					...
					<div class="<?php echo esc_attr($class); ?>">
						<article>
							...
							<div>
								...
								<a class="uk-button-text color-brand" href="<?php the_permalink();?>"><?php esc_html_e('Read More', 'medio'); ?></a>
							</div><!-- /.blog-content -->
						</article>
					</div>
				<?php } ?>
