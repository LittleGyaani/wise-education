...
if ( !function_exists( 'talemy_get_post_hero_style' ) ) {
	 ...
	 * @return void
	 */
	function talemy_get_post_hero_style( $show_default = true ) {
		...
		if ( !empty( $background ) && is_array( $background ) ) {
			...
			} elseif ( $show_default && has_post_thumbnail() ) {
	...
	function talemy_nav_login( $avatar_size = 24 ) {
		...
		if ( is_user_logged_in() ) :
			...
			<div class="nav-item-wrap dropdown-open-on-hover">
				<a href="<?php echo esc_url( $user_link ); ?>" class="nav-btn btn-login btn-has-dropdown"><?php echo get_avatar( $user_id, $avatar_size ); ?><span><?php echo esc_attr( $user_data->user_nicename ); ?></span></a>
