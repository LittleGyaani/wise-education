...
$this->sections['bauer_maincontent_general'] = array(
	'title' => esc_html__( 'General', 'bauer' ),
	'panel' => 'bauer_maincontent',
	'settings' => array(
		array(
...
// Main Content Left
$this->sections['bauer_maincontent_left'] = array(
	...
	'settings' => array(
		array(
			...
			'control' => array (
				...
				'description' => esc_html__( 'Top Right Bottom Left. Example: 30px', 'bauer' ),
			),
			'inline_css' => array(
...
// Main Content Right
$this->sections['bauer_maincontent_right'] = array(
	'title' => esc_html__( 'Sidebar', 'bauer' ),
	'panel' => 'bauer_maincontent',
	'settings' => array(
		array(
		...
		array(
			...
			'control' => array (
				'type' => 'text',
				'label' => esc_html__( 'Border Width', 'bauer' ),
				'description' => esc_html__( 'Top Right Bottom Left. Example: 0px 3px 3px 0px', 'bauer' ),
			),
			'inline_css' => array(
				'target' => '.sidebar-left #sidebar, .sidebar-right #sidebar',
				'alter' => 'border-width',
