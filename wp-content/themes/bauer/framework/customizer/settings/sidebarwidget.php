...
$this->sections['bauer_sidebar_widget_general'] = array(
	'title' => esc_html__( 'Widget General', 'bauer' ),
	'panel' => 'bauer_sidebarwidget',
	'settings' => array(
		array(
			'id' => 'sidebar_widget_bottom_padding',
			'transport' => 'postMessage',
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Widget Bottom Margin', 'bauer' ),
				'description' => esc_html__( 'Example: 50px.', 'bauer' ),
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Widget Bottom Padding', 'bauer' ),
		...
		array(
			'id' => 'sidebar_widget_line_color',
			'transport' => 'postMessage',
			'control' => array(
				'type' => 'color',
				'label' => esc_html__( 'Widget: Line Color', 'bauer' ),
			),
			'inline_css' => array(
				'target' => '#sidebar .widget',
				'alter' => 'border-color',
		...
		array(
			...
			'control' => array(
				...
				'description' => esc_html__( 'Top Right Bottom Left. Ex: 0px 0px 5px 0px', 'bauer' ),
			),
			'inline_css' => array(
				'target' => array(
...
// Widget Search
$this->sections['bauer_sidebar_widget_search'] = array(
	...
	'settings' => array(
		...
		array(
			'id' => 'sidebar_widget_search_form_icon_background',
			'transport' => 'postMessage',
			'control' => array(
				'type' => 'color',
				'label' => esc_html__( 'Icon Background', 'bauer' ),
			),
			'inline_css' => array(
				'target' => '#sidebar .widget.widget_search .search-form .search-submit:before',
...
// Widget Built-In
$this->sections['bauer_sidebar_widget_built_in'] = array(
	...
	'settings' => array(
		array(
			...
			'control' => array (
				...
				'description' => esc_html__( 'Top Right Bottom Left. Ex: 13px 0px', 'bauer' ),
			),
			'inline_css' => array(
				'target' => array(
...
// Widget Tags
$this->sections['bauer_sidebar_widget_tags'] = array(
	'title' => esc_html__( 'Widget: Tags', 'bauer' ),
	'panel' => 'bauer_sidebarwidget',
	'settings' => array(
		array(
