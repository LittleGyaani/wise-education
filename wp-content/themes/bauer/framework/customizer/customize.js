...
var objBg = {
	...
	header_five_background: ".header-style-5 #site-header:after",
	header_six_background: ".header-style-6 #site-header:after",
	...
	blog_entry_meta_item_icon_color: ".hentry .post-meta .item .inner:before",
	sidebar_widget_search_form_icon_background: "#sidebar .widget.widget_search .search-form .search-submit:before",
	sidebar_widget_tags_background: "#sidebar .widget.widget_tag_cloud .tagcloud a",
	promo_background: ".footer-promotion",
...
var objColor = {
	...
	header_aside_text_color: "#site-header .aside-content .info-c",
...
var objBoderColor = {
	...
	header_five_border_color: ".header-style-5 #site-header",
	header_six_border_color: ".header-style-6 #site-header",
	left_content_border_color: "#inner-content:after",
	right_content_border_color: ".sidebar-left #sidebar, .sidebar-right #sidebar",
	sidebar_widget_line_color: "#sidebar .widget",
...
var objBorderWidth = {
	...
	header_five_border_width: ".header-style-5 #site-header",
	header_six_border_width: ".header-style-6 #site-header",
...
var objPadding = {
	header_four_padding: ".header-style-4 #site-header .bauer-container",
...
var objMargin = {
	...
	header_aside_search_icon_margin: '.header-style-5 .header-search-wrap, .header-style-6 .header-search-wrap',
	header_cart_icon_margin: '.nav-top-cart-wrapper',
	header_aside_cart_icon_margin: '.header-style-5 .nav-top-cart-wrapper, .header-style-6 .nav-top-cart-wrapper',
...
var objWidth = {
	aside_info_one_width: "#site-header .aside-content .inner > span.info-one",
	aside_info_two_width: "#site-header .aside-content .inner > span.info-two",
	aside_info_three_width: "#site-header .aside-content .inner > span.info-three",
	left_container_width: "#site-content",
	sidebar_width: ".sidebar-left #sidebar, .sidebar-right #sidebar",
	site_desktop_container_width: ".site-layout-full-width .bauer-container, .site-layout-boxed #page",
...
var objTopPadding = {
	sidebar_widget_bottom_padding: "#sidebar .widget",
...
var objOpacity = {
	...
	header_five_background_opacity: ".header-style-5 #site-header:after",
	header_six_background_opacity: ".header-style-6 #site-header:after",
}
...
var headersPadding = {
	...
	header_five_padding: ".header-style-5 #site-header-inner",
	header_six_padding: ".header-style-6 #site-header-inner",
}
