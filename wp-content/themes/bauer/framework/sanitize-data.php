...
if ( ! class_exists( 'Bauer_Sanitize_Data' ) ) {
	class Bauer_Sanitize_Data {
...
// Helper function runs the Bauer_Sanitize_Data class
function bauer_sanitize_data( $data = '', $type = '' ) {
	if ( $data && $type ) {
		$class = new Bauer_Sanitize_Data();
